...
export function BookingListPage(props: BookingListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['pick_up_location.contains', 'drop_off_location.contains'],
          ...params.filters,
        },
        'booking',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'pick_up_location', header: 'Pick Up Location', accessorKey: 'pick_up_location' },
    { id: 'drop_off_location', header: 'Drop Off Location', accessorKey: 'drop_off_location' },
